...
<!-- Slider Part -->
		...
		<div class="container">
			<!-- Content Part -->
			<div class="col-100 author_text">
				<div class="intro">
					<h6 class="text1">Tired of a busy life ???</h6>
					<h2 class="text2">Take a break & <br>a Relax Tour....</h2>
					<button type="submit" onclick="window.location.href = 'index.php#about';" class="btn">Get Started with Us!</button>
				</div>
			</div>
		</div>
		</section>
		...
		<section id="about">
			<div class="container">
					<!-- About me content -->
					<div>
						<h2>About <b>RS TOURS LTD</b></h2>
						<p>RS TOURS LTD aims to increase awareness of many tourist attractions, to encourage and support travel to RS TOURS LTD. Although associated with the RS TOURS LTD National Tourist Office – North America, RS TOURS LTD remains an independent, non-profit, initiative to produce Web content and to offer assistance to North-American and Australian travelers interested in visiting RS TOURS LTD. About the RS TOURS LTD National Tourist Office The RS TOURS LTD National Tourist Office — North America (MtNTO) is the official representative of the RS TOURS LTD Tourist Authority Founded in 2012 to satisfy the growing demand for trusted information and knowledge about tourism , MtNTO's mission is to represent all the components of RS TOURS LTD travel industry and to promote and facilitate increased inbound travel. MtNTO's activities include: Providing information to North American travelers, press, tour operators and travel agencies regarding tourist attractions, travel conditions, events and tourist facilities within RS TOURS LTD. Facilitating contacts and cooperation between North American and RS TOURS LTD organizations and business companies involved in travel and tourism in RS TOURS LTD Marketing activities aimed at increasing awareness of tourist attractions among media, consumers and business companies resulting in increased visitation to RS TOURS LTD. We handle all types of travel; everything from airline tickets, Canadian & International tours, packaged vacations in Canada, the United States and abroad, cruises & hotel bookings. We're also experts in travel to the island paradise of Cuba. We're also "specialists" in educational and youth organization tour travel. Our student travel services are second to none, which enables us to provide your student or youth organization group with excellent tours across North America, Britain and Europe. Whether you're a seasoned traveller, or a first timer, our goal is to ensure your vacation exceeds your expectations. If you're looking for a Tour Package to an international destination, you should pay a visit our Tour Information page first. You'll find everything you need to know about Tour selection and buying. </p>
					</div>
					<div>
					...
					<div>
						...
						<p>While traveling you should always keep in mind certain transportation safety tips as well:- Always choose the safest mode of transport for traveling. Do check its previous safety track record.
						...
						Wear money belts, hidden neck and waist pouches, hidden pocket wallets and zippered compartments under your clothes to avoid pick pocketing.</p>
					
						<h3>HOTEL SAFETY TIPS:</h3>
			...
			<div class="container">
					...
					<div>
						...
						<div class="col-33">
							...
							<h3> Accommodation </h3>
							<p> Accommodation is all about making room — it can mean a room or place where you will stay or an agreement about sharing something.</p>
							</div>
						</div>
						...
						<div class="col-33"> 
							...
							<h3> Bus Hire </h3>
							<p>  Bus hire, also known as vehicle for hire, is a service that provides private or shared transportation for a fee. It is a cost-effective option for traveling and can be used for a variety of purposes, such as weddings,etc. </p>
							</div>
						</div>
						...
						<div class="content">
							...
							<p> A delivery service is a business that transports goods or services from one location to another. Delivery services are similar to postal services, but are typically faster and more flexible in terms of delivery address and volume.</p>
							</div>
						</div>
						...
						<div class="content">
							...
							<h3> Food Services </h3>
							<p> Food Service means the goods and services customarily offered by restaurants, cafeterias, snack bars or vending machines for food or beverages.</p>
							</div>
						</div>
						...
						<div class="content">
							...
							<h3> Road Guidance </h3>
							<p> Many countries have developed their own road guidance guidelines. These guidelines are often based on existing guidelines, technical documents, research results, and technological developments..</p>
							</div>
						</div>
						...
						<p> Emergency services are organizations that ensure public safety, security, and health by addressing and resolving different emergencies.</p>
						</div>
						</div>
					</div>
			</div>
